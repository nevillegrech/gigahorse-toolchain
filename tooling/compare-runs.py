...
parser = argparse.ArgumentParser(
    prog="Compare Runs", description="Compares multiple runs of gigahorse.py using the produced json files"
)

parser.add_argument("result_files", nargs="*")
parser.add_argument("-v", "--verbose", action="store_true")
parser.add_argument(
    "-d", "--decomp", action="store_true", help="Includes core decompilation specific relations and analytics"
)
parser.add_argument(
    "-m", "--memory", action="store_true", help="Includes memory modeling specific relations and analytics"
)
parser.add_argument(
    "-s", "--storage", action="store_true", help="Includes storage modeling specific relations and analytics"
)
parser.add_argument("-c", "--clients", action="store_true", help="Includes client specific relations and analytics")
